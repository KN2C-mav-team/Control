	...
	if(Mpc->UART_IRQ_FLAG)
		{
			if(!Mpc->ready)
			{
				...
				for(int co=0;co<MPC_BUFF_AMOUNT;co++)
				{
...
//		{		
//			if(Mpc_2->MPC_UART_BUFF_2[0] == 255 && Mpc_2->MPC_UART_BUFF_2[1] == 180 && Mpc_2->MPC_UART_BUFF_2[2] == 255)
//			{
//				if(Mpc_2->MPC_UART_BUFF_2[3] > 127) MPC_2.data[0] = Mpc_2->MPC_UART_BUFF_2[3] - 256;
//				else MPC_2.data[0] = Mpc_2->MPC_UART_BUFF_2[3];
//				
//				if(Mpc_2->MPC_UART_BUFF_2[4] > 127) MPC_2.data[1] = Mpc_2->MPC_UART_BUFF_2[4] - 256;
//				else MPC_2.data[1] = Mpc_2->MPC_UART_BUFF_2[4];
//			}
//			else
//			{
//				MPC_2.data[0] = 0;
